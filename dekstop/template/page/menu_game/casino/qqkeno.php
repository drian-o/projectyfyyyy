	...
	<div class="main-content slot-game">
		<div class="container">
			<div class="slot-game__container">
				<div class="page-header">Qq Keno</div>
				<div class="slot-game-list">
					<?php 

					$id_provider = 'QK';
					$query = mysqli_query($koneksi, "SELECT * FROM tb_games WHERE game_provider = '$id_provider' AND game_type = 'LK' LIMIT 40");
					while ($data = mysqli_fetch_array($query)) {
						...
						if($cek > 0){
							$playUrl = 'index.php?page=livegame_qqkeno&pesan=22';
						}else{
							$idgame = $data['gameid'];
							if ($id_login == '') {
								...
								$playUrl = $urlweb . "/main/PlayGame.php?p=".$extplayer."&id=".$data['game_code'];
							} 
						}
						?>
