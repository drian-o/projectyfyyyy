 ...
 <main id="main-route">
    <div class="main-content register post">
        <div class="container">
            <div class="row">
                            ...
                            <div class="register-form">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            placeholder="nama@domain.com" onkeyup="saveValue(this);" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <select class="form-control" name="bank" id="bank" onkeyup="saveValue(this);" required="">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                ...
                                                id="phone" minlength="8" maxlength="20" placeholder="Nomor Ponsel*" onkeyup="saveValue(this);" required="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group" id="accountName">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            id="accName" minlength="2" maxlength="25"
                                            placeholder="Nama Sesuai Rekening" onkeyup="saveValue(this);" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group" id="accountNumber">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <input class="form-control" value="" type="number" name="norek"
                                            id="accNumber" minlength="" maxlength="20"
                                            placeholder="Nomor Sesuai Rekening" onkeyup="saveValue(this);" required="">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                ...
                <script>
      //No space input
      $("#username_register,#email,#phone,#accNumber").on({
        keydown: function(e) {
          if (e.which === 32)
            return false;
        },
    ...
    <script>
      //Save cache record
      document.getElementById("username_register").value = getSavedValue("username_register");
      document.getElementById("email").value = getSavedValue("email");
      document.getElementById("phone").value = getSavedValue("phone");
      document.getElementById("bank").value = getSavedValue("bank");
      document.getElementById("accName").value = getSavedValue("accName");
      document.getElementById("accNumber").value = getSavedValue("accNumber");
