                ...
                if (empty($id_login)) { 
                    ?>
                        <div class="game-holder">
                            ...
                            <div class="game-holder">
                            <div class="game-img">
                                <img title="SBO SPORTS" alt="SBO SPORTS"
                                src="https://images.linkcdn.cloud/global/banner/sbobet.jpg">
                            </div>
                            <div class="game-bottom">
                                <div class="game-name">
                                    SBO SPORTS
                                ...
                                <div class="game-links main-sekarang-alert">
                                    <a class="btn-custom" href="?page=sports_sbo">
                                        Main Sekarang</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="game-holder">
                            ...
                            <div class="game-bottom">
                                ...
                                <div class="game-links main-sekarang-alert">
                                <a class="btn-custom" href="javascript:;" onclick="gameMaintenance('sports_sbo', '?page=sports_sbo')">
                                        Main Sekarang</a>
                                </div>
                            </div>
                        </div>
