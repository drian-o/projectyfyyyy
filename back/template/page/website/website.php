                    ...
                    <div class="card-body">
                        ...
                        while ($data = mysqli_fetch_array($query)) {
                            ...
                            <form class="form p-t-20" enctype="multipart/form-data" action="?page=edit_website" method="POST">
                                ...
                                <!-- Form untuk status maintenance -->
                                <div class="form-group">
                                    <label>Mode Maintenance</label>
                                    <select name="maintenance_status" class="form-control">
                                        <option value="not" <?php if ($data['mtweb'] === 'not') echo 'selected="selected"'; ?>>Tidak Aktif</option>
                                        <option value="active" <?php if ($data['mtweb'] === 'active') echo 'selected="selected"'; ?>>Aktif</option>
                                    </select>
                                </div>
                                <!-- Akhir form untuk status maintenance -->
