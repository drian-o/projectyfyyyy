								...
								<div class="form-group">
									...
									<div class="input-group mb-3">
										<select class="form-control" name="warna">
											...
											<option value="ungu-hitam" <?php echo ($selectedColor == 'ungu-hitam') ? 'selected' : ''; ?>>ungu - hitam</option>
											<option value="biru-putih" <?php echo ($selectedColor == 'biru-putih') ? 'selected' : ''; ?>>biru - putih</option>
										</select>
									</div>
								</div>
