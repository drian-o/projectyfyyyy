...
<script type="text/javascript">
    Swal.fire({
        title: 'Maaf!',
        text: 'Anda Tidak Berkepentingan Disini',
        icon: 'warning',
        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent">
                    ...
                    <!-- ============================================================== -->
                    <script>
                    var ehayker = "<?php echo $chaykerjs; ?>";
                                    ...
                                    <ul id="sidebarnav">
                                        ...
                                        <li class="sidebar-item"> 
                                            ...
                                            <ul aria-expanded="false" class="collapse first-level">
                                                <li class="sidebar-item">
                                                    <a href="<?php echo $endpoint; ?>" class="sidebar-link">
                                                        <i class="mdi mdi-octagram"></i>
                                                        <span class="hide-menu">API Game Backoffice</span>
                                                    </a>
                                                </li>
                                                <li class="sidebar-item">
                                                    <a href="?page=history" class="sidebar-link">
                                                        <i class="mdi mdi-octagram"></i>
                                                        <span class="hide-menu">History Betting Member</span>
                                                    </a>
                                                </li>
                                                <li class="sidebar-item">
                                                    <a href="?page=mtgame" class="sidebar-link">
                                                        <i class="mdi mdi-octagram"></i>
                                                        <span class="hide-menu">Game Maintenance</span>
                                                    </a>
                                                </li>
                                                </ul>
                                            </li>
                ...
                //Banner
                                      ...
                                      include 'page/game/history.php';
                                  }else if  ($_GET['page'] == "mtgame") {
                                      include 'page/game/mtgame.php';
                              ...
                              else if ($_GET['page'] == "riwayatmember")
                                  include 'page/member/riwayat.php';  
